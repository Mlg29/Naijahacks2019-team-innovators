        ...
        <div className="about">
            ...
            <div className="about-section">
                <div className="about-section-div">
                    ...
                    <p className="about-section-paragraph">At NaijaRecycler, we intend to have a fleet of orange trucks. One of which will come to your sites to collect all of your waste in bags that we give to you. Then we bring the waste to our sorting sites, where the waste will be sorted into more than 40 waste fractions. The three major sorting categories are organic waste, dry recyclables (paper, plastic, metal and glass) and residual waste. We then turn the organic waste into compost at our compost site, which will then sell to farms so that they can grow healthy crops. The dry recyclables are sorted and either processed internally or through one of our recycling partners. As we intend to recycle 95% of the waste we collect, we will only take 5% to a landfills (mostly diapers and sanitary towels).</p>
                </div>

                <div>
                    <img className="about-section-image" src="https://res.cloudinary.com/dtbjhs8a6/image/upload/v1576344834/ya2zn8hzmmcagawqbkpw.png" alt="" width="700"/>
                </div>
            </div>
            ...
            <div className="about-impact">
                <div className="about-impact-div">
                    ...
                    <p className="about-impact-paragraph">We intend recycle 95% of the waste we collect – which is one of the highest recycling rates in the world (the USA only recycle 35%)</p>
                ...
                <div className="about-impact-div2">
                    <p className="about-impact-paragraph">We intend to create 250 full-time jobs.
